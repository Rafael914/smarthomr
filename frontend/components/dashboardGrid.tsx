...
export default function DashboardGrid() {
  ...
  const handleLogout = () => {
    ...
    // e.g. navigation.replace("Login") or authContext.signOut()
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.header}>
        {/* Left spacer — mirrors logout button width to keep title truly centered */}
...
const styles = StyleSheet.create({
  ...
  // Matches logout button width so headerCenter stays perfectly centered
  headerSpacer: {
    width: 80,
  },
  headerCenter: {
